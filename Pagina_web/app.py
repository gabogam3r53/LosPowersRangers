        ...
        with st.container():
            ...
            st.markdown("""
                **Análisis de correlaciones entre estadísticas y valor de contrato en la WNBA**
                ...
                En este análisis exploramos la relación entre las estadísticas individuales de las jugadoras de la WNBA y el valor de sus contratos, utilizando datos de las temporadas 2016-2024. A través de gráficas de dispersión, visualizamos cómo variables como puntos por partido (PTS), intentos y aciertos de campo (FGA, FGM), minutos jugados (MIN), valoración (FP), pérdidas de balón (TOV) y rango (RANK) se relacionan con el valor de mercado de las jugadoras.
        
                **Principales hallazgos:**
        
                * **Correlación positiva:** Observamos una fuerte correlación positiva entre el valor de contrato y estadísticas como PTS, FGM, FGA, MIN, FP y TOV. Esto indica que, en general, las jugadoras con mayor producción ofensiva, mayor participación en el juego y mejor eficiencia tienden a tener contratos más altos.
                * **Correlación negativa:** Por otro lado, encontramos una correlación negativa significativa entre el rango de la jugadora y el valor de su contrato. Este resultado es intuitivo, ya que las jugadoras con un rango más bajo (es decir, mejor clasificadas) suelen ser más valoradas en el mercado.
